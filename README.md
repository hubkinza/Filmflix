...
|--------------------------|------------------|------------------------------------------|
| **Body Background**      | `#121212`        | Main dark background color               |
| **Navbar & Sections**    | `#111111`        | Used for navbar and filter section       |
| **Primary Text**         | `#ffffff`        | Main text color for readability          |
| **Accent - Red Button**  | `red`            | Highlight action like reset filters      |
| **Card Background**      | `white`          | Movie cards and modal base color         |
| **Muted Text**           | `#939191`        | Footer and secondary text                |

### Wireframes 
### Landing page 
<img width="749" height="485" alt="image" src="https://github.com/user-attachments/assets/22f3811f-1725-4688-b7ee-0281e538a1a2" />

### Movie Details Page
<img width="754" height="488" alt="image" src="https://github.com/user-attachments/assets/0468780e-8207-4f7e-ad67-8fe0097b8f8e" />

### Top Rated Movies page
<img width="757" height="485" alt="image" src="https://github.com/user-attachments/assets/0c0d79e0-b655-44aa-b992-6f6ae9a4b81d" />
...
### HTML Validator
#### Landing Page
<img width="1920" height="855" alt="image" src="https://github.com/user-attachments/assets/2b3e70f1-ffd1-4be4-9dc3-99f13053fe44" />

####  Movie Details Page
<img width="1894" height="870" alt="image" src="https://github.com/user-attachments/assets/844e0685-560c-4981-b273-608b5e85cfcd" />

#### Top Rated Movies page
<img width="1876" height="868" alt="image" src="https://github.com/user-attachments/assets/a3ee7cf3-4789-4d8a-90be-3f1a8153beb5" />

#### About page
<img width="1889" height="848" alt="image" src="https://github.com/user-attachments/assets/0e6f545c-a0f2-41d3-b653-b712a0e58469" />
...
#### Top rated Movies
<img width="1920" height="872" alt="image" src="https://github.com/user-attachments/assets/7dd4e367-2f19-46dd-9f61-fd48fb18c083" />

#### Movie details 
<img width="1920" height="866" alt="image" src="https://github.com/user-attachments/assets/5d949a43-9cf6-4a57-a3dc-0805a7e280e5" />

### Lighthouse 
<img width="1920" height="1020" alt="image" src="https://github.com/user-attachments/assets/4354e447-aaee-455a-809c-0c142fb446e0" />
...
🔗 Live Site: [https://hubkinza.github.io/Filmflix/](https://hubkinza.github.io/Filmflix/)

To deploy or update:
1. Push your latest code to the `main` or `master` branch
2. Go to the repository’s **Settings > Pages**
3. Set source to `/ (root)` or the folder containing `index.html`
